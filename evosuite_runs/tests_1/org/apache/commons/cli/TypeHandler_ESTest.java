...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("q?cnq!{wN");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "q?cnq!{wN");
      File file0 = TypeHandler.createFile("q?cnq!{wN");
      assertEquals(9L, file0.length());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile(".^w+;mtm7JV2");
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("[Ka0DV", (Object) "[Ka0DV");
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("=<eau(O:KYopVW", class0);
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("9|lJ.T");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"9|lJ.T\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      File file0 = TypeHandler.createFile("/2e2j[nd?LmJ{]L");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("y|a$");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: y|a$
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles(".^w+;mtm7JV2");
        fail("Expecting exception: UnsupportedOperationException");
