...
public class AmbiguousOptionException_ESTest extends AmbiguousOptionException_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        ambiguousOptionException0 = new AmbiguousOptionException("\";~@q+/G:nx", (Collection<String>) null);
  ...
  public void test1()  throws Throwable  {
      List<String> list0 = List.of("'", "h`UbQ:-wi%TW", "", "(^&;E9%9tsEs0#", "org.apache.commons.cli.UnrecognizedOptionException", "h`UbQ:-wi%TW");
      AmbiguousOptionException ambiguousOptionException0 = new AmbiguousOptionException("h`UbQ:-wi%TW", list0);
  }
