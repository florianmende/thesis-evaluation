...
public class GnuParser_ESTest extends GnuParser_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "--_:asE -E=IUu{jXl_";
      Options options1 = options0.addRequiredOption("", "", true, "--_:asE -E=IUu{jXl_");
  ...
  public void test2()  throws Throwable  {
      Options options0 = new Options();
      GnuParser gnuParser0 = new GnuParser();
      options0.addOption("", "-=R=(ncr;$S\"\".29jf");
      String[] stringArray0 = new String[7];
      stringArray0[0] = "";
      stringArray0[1] = "~&C;2ZR_A";
      stringArray0[2] = ": ";
      stringArray0[3] = "0";
      stringArray0[4] = "-=R=(ncr;$S\"\".29jf";
      // Undeclared exception!
      try { 
  ...
  public void test7()  throws Throwable  {
      ...
      stringArray0[0] = "-R&6=(ncrSp\"\".529jf";
