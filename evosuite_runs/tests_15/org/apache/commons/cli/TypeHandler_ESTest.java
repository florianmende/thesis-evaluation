...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, " [7B4OGwjrQ:*");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("` _)10%sB,mLQW=.mw");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "NY;");
      File file0 = TypeHandler.createFile("` _)10%sB,mLQW=.mw");
      assertTrue(file0.isFile());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".R4s9O\"8");
      assertEquals(".R4s9O\"8", file0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("]H]", (Object) "]H]");
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("yP@[Zx[", class0);
        fail("Expecting exception: Exception");
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createNumber("cw\\5~xz>bhRB.]X|");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"cw\\5~xz>bhRB.]X|\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      File file0 = TypeHandler.createFile("/f4L(p'J;w0l");
      assertFalse(file0.isHidden());
  }
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createFiles("zC?)':L+h8RVnsN+oJ");
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test26()  throws Throwable  {
      try { 
        TypeHandler.createClass(".R4s9O\"8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: .R4s9O\"8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
