...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("v", "8S7'.Q\u0000+e");
  ...
  public void test07()  throws Throwable  {
      ...
      Option option1 = new Option("kVj", false, "kVj");
      optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-v 8S7'.Q\u0000+e, -kVj kVj]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      option0.setLongOpt("n$)upDQy&;sOR$i");
      optionGroup0.setSelected(option0);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'null' was specified but an option from this group has already been selected: 'n$)upDQy&;sOR$i'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
