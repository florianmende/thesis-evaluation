...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("$m(QK;+)B@");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "Not yet implemented");
      FileInputStream fileInputStream0 = TypeHandler.openFile("$m(QK;+)B@");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("+bxq[6*KNiP1");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "+bxq[6*KNiP1");
      File file0 = TypeHandler.createFile("+bxq[6*KNiP1");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".t@7O3\"vp'5H%!mWL&");
      assertFalse(file0.isAbsolute());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/03x&t0qf.");
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue(":/c?LT8mhBd[}", (Object) ":/c?LT8mhBd[}");
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("I", class0);
        fail("Expecting exception: Exception");
  ...
  public void test17()  throws Throwable  {
      try { 
        TypeHandler.createObject("Unable to handle the class: ");
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      try { 
        TypeHandler.createNumber("`*~N?@.7r");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"`*~N?@.7r\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("8Tl{2&=C2&kbc<)yG]");
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.openFile("+bxq[6*KNiP1");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: +bxq[6*KNiP1
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
