...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("wW7]L");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "");
      FileInputStream fileInputStream0 = TypeHandler.openFile("wW7]L");
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile(".ujn?2469.");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "'9@9vSlsxhm{WDh+Us");
      File file0 = TypeHandler.createFile(".ujn?2469.");
      assertEquals(0L, file0.getUsableSpace());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/Z>YU8V {GM&p|Cn");
      assertEquals("Z>YU8V {GM&p|Cn", file0.getName());
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createValue("VdGiPDq5`Z", (Object) "VdGiPDq5`Z");
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("nr^@v5$j3)\">B", class0);
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      try { 
        TypeHandler.createURL("y&VbT<~Nnm9Qzq{J]s~\"");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: y&VbT<~Nnm9Qzq{J]s~\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      try { 
        TypeHandler.openFile("wW7]L");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: wW7]L
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      try { 
        TypeHandler.createClass("x%RY3Q==B@ql/?");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: x%RY3Q==B@ql/?
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
