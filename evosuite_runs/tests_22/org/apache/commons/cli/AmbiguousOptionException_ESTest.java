...
public class AmbiguousOptionException_ESTest extends AmbiguousOptionException_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        ambiguousOptionException0 = new AmbiguousOptionException("i%v", (Collection<String>) null);
  ...
  public void test1()  throws Throwable  {
      List<String> list0 = List.of("28Y=U@KwEq", "", "'  (could be: ", "", "", "");
      AmbiguousOptionException ambiguousOptionException0 = new AmbiguousOptionException("pS2qfbk'", list0);
  }
