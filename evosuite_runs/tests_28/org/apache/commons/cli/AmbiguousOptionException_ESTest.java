...
public class AmbiguousOptionException_ESTest extends AmbiguousOptionException_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        ambiguousOptionException0 = new AmbiguousOptionException("Qj=", (Collection<String>) null);
  ...
  public void test1()  throws Throwable  {
      List<String> list0 = List.of("", "org.apache.commons.cli.ParseException", "", "&4o[FB", "T/yoJ#?8OI1*yxR");
  ...
  public void test2()  throws Throwable  {
      ...
      AmbiguousOptionException ambiguousOptionException0 = new AmbiguousOptionException("'  (could be: ", linkedList0);
      Collection<String> collection0 = ambiguousOptionException0.getMatchingOptions();
      assertFalse(collection0.contains("'  (could be: "));
  }
}
