...
public class Option_ESTest extends Option_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Option option0 = new Option("NO_RGS_ALLOWED", "NO_RGS_ALLOWED");
      option0.setArgs((-2));
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals((-2060), option0.getArgs());
  ...
  public void test10()  throws Throwable  {
      ...
      option0.setArgs((-2));
      option0.addValueForProcessing("\"M}=,ig8~31B2d.1ZTk");
      option0.getValue();
  ...
  public void test19()  throws Throwable  {
      Option option0 = new Option("6ki", "B^L+4DH");
      int int0 = option0.getId();
      assertEquals("B^L+4DH", option0.getDescription());
      assertFalse(option0.hasLongOpt());
      assertEquals((-1), option0.getArgs());
  ...
  public void test22()  throws Throwable  {
      Option option0 = new Option((String) null, "NO_RGS_ALLOWED");
      assertEquals((-1), option0.getArgs());
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        Option.builder("jU oL(M7iplA1YT");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'jU oL(M7iplA1YT' contains an illegal character : ' '
         //
  ...
  public void test31()  throws Throwable  {
      Option option0 = null;
      try {
        option0 = new Option("NO_(GS_ALLOWED", true, "NO_(GS_ALLOWED");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'NO_(GS_ALLOWED' contains an illegal character : '('
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      Option option0 = null;
      try {
        option0 = new Option("NO_(GS_ALLOWEp", "NO_(GS_ALLOWEp", true, "NO_(GS_ALLOWEp");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'NO_(GS_ALLOWEp' contains an illegal character : '('
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test37()  throws Throwable  {
      Option option0 = new Option("", "", true, "");
      option0.setArgs(2309);
      boolean boolean0 = option0.hasArgs();
      assertEquals(2309, option0.getArgs());
      assertTrue(boolean0);
  }
  ...
  public void test57()  throws Throwable  {
      ...
      option0.addValueForProcessing("\"");
      String string0 = option0.getValue("yQGy:e");
      assertFalse(option0.hasValueSeparator());
  ...
  public void test60()  throws Throwable  {
      ...
      option0.addValueForProcessing("y*X!=/$YsiP)!r8");
  ...
  public void test63()  throws Throwable  {
      Option option0 = new Option("N_RGS_LLOWED", "N_RGS_LLOWED");
  ...
  public void test64()  throws Throwable  {
      ...
      Option option1 = new Option("W", "W", false, "W");
  ...
  public void test77()  throws Throwable  {
      Option option0 = new Option("dg", "dg");
      // Undeclared exception!
      try { 
        option0.addValue("dg");
  ...
  public void test91()  throws Throwable  {
      Option option0 = new Option("NRO_ARGS_ALLOWED", "NRO_ARGS_ALLOWED", true, "NRO_ARGS_ALLOWED");
      option0.setValueSeparator('N');
      option0.addValueForProcessing("NRO_ARGS_ALLOWED");
  ...
  public void test94()  throws Throwable  {
      Option.Builder option_Builder0 = Option.builder("");
      Option.Builder option_Builder1 = option_Builder0.numberOfArgs(61);
      assertSame(option_Builder0, option_Builder1);
  }
  ...
  public void test97()  throws Throwable  {
      Option.Builder option_Builder0 = Option.builder("");
      Option.Builder option_Builder1 = option_Builder0.desc("y*X!=/$YsiP)!r8");
      assertSame(option_Builder1, option_Builder0);
  }
  ...
  public void test99()  throws Throwable  {
      Option.Builder option_Builder0 = Option.builder("");
      Option.Builder option_Builder1 = option_Builder0.valueSeparator();
      option_Builder1.numberOfArgs(61);
      Option option0 = option_Builder1.build();
      option0.addValueForProcessing("y*X!=/$YsiP)!r8");
      assertEquals("y*X!", option0.getValue());
