...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("EU", false, "EU");
  ...
  public void test05()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("$CWgqLo", "$CWgqLo");
      optionGroup0.addOption(option0);
      Option option1 = new Option("", "$CWgqLo");
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-$CWgqLo $CWgqLo, - $CWgqLo]", string0);
  }
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("kr_", "kr_");
      Option option1 = new Option("lr_", "kr_");
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'kr_' was specified but an option from this group has already been selected: 'lr_'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
