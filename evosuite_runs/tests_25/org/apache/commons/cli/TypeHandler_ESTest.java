...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "PbI)Q-");
  ...
  public void test06()  throws Throwable  {
      try { 
        TypeHandler.openFile("m{K[*`:b-p`+uJq6");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: m{K[*`:b-p`+uJq6
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("=??T>e>NZFHE", class0);
        fail("Expecting exception: Exception");
  ...
  public void test18()  throws Throwable  {
      File file0 = TypeHandler.createFile("`TR`/.S;Wz");
