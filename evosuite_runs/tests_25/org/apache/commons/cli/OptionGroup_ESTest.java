...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option("Uv", ", ", false, "\"xl");
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "!k+zFgGkpOy");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "'CX<@`[OAXoT)5{YqT");
  ...
  public void test06()  throws Throwable  {
      ...
      Option option1 = new Option("m", "n");
      OptionGroup optionGroup0 = new OptionGroup();
      OptionGroup optionGroup1 = optionGroup0.addOption(option1);
      optionGroup1.addOption(option0);
      String string0 = optionGroup0.toString();
      assertEquals("[-m n, -n n]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", true, "!k+FgGkOy");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("Tj", "", true, (String) null);
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'Tj' was specified but an option from this group has already been selected: ''
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
