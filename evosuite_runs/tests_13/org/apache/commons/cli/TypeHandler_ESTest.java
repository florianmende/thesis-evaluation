...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile(".VnFQQ`Z:R)DuGg");
      assertEquals(".VnFQQ`Z:R)DuGg", file0.toString());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      File file0 = TypeHandler.createFile("/XIBV#!hQ");
      assertFalse(file0.isHidden());
  }
  ...
  public void test19()  throws Throwable  {
      try { 
        TypeHandler.createObject("`;acW77&+Q.Wg}");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: `;acW77&+Q.Wg}
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
