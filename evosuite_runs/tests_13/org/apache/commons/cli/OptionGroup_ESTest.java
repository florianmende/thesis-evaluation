...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("kb", false, "nl4\u001BfLFawV?\"3");
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("Pn", "The&addValue method is not intended for clien} use. Subclasses should use the addValueForProcessing method instead. ", true, " ");
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option("", "bO*Za{");
      optionGroup1.addOption(option1);
      String string0 = optionGroup1.toString();
      assertEquals("[-Pn  , - bO*Za{]", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Option option0 = new Option("", (String) null);
      optionGroup0.setSelected(option0);
      Option option1 = new Option((String) null, (String) null, true, "w]rUr[Ey,%vcV");
      try { 
