...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("cV", ")-K](snS_%?");
  ...
  public void test02()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("", "X<8N{6p");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("[- X<8N{6p, --null]", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("d", "lx");
      optionGroup0.setSelected(option0);
      Option option1 = new Option("lx", "lx");
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option 'lx' was specified but an option from this group has already been selected: 'd'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
