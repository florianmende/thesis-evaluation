...
public class MissingArgumentException_ESTest extends MissingArgumentException_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MissingArgumentException missingArgumentException0 = new MissingArgumentException("2%:Y{eb1bypnPOXj");
  ...
  public void test4()  throws Throwable  {
      Option option0 = new Option((String) null, (String) null);
      option0.setArgName("mSnas'olZ/HYWv;@Y");
      MissingArgumentException missingArgumentException0 = new MissingArgumentException(option0);
      Option option1 = missingArgumentException0.getOption();
  ...
  public void test5()  throws Throwable  {
      Option option0 = new Option((String) null, "wF{$5(<", true, "yk");
      MissingArgumentException missingArgumentException0 = new MissingArgumentException(option0);
      Option option1 = missingArgumentException0.getOption();
  ...
  public void test6()  throws Throwable  {
      Option option0 = new Option("", "org.apache.commons.cli.MissingArgumentException", false, "Cannot add value, list full.");
      option0.setArgs(0);
      MissingArgumentException missingArgumentException0 = new MissingArgumentException(option0);
      Option option1 = missingArgumentException0.getOption();
