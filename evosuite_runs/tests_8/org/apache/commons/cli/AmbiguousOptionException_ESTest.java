...
public class AmbiguousOptionException_ESTest extends AmbiguousOptionException_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      List<String> list0 = List.of("fl", "fl", "fl", "?30x-Dxz;lpBR^", "%=2;7yf-#oR9[YGX<?", "fl", "?30x-Dxz;lpBR^", "%=2;7yf-#oR9[YGX<?", "%%h", "");
      AmbiguousOptionException ambiguousOptionException0 = new AmbiguousOptionException("?30x-Dxz;lpBR^", list0);
  }
