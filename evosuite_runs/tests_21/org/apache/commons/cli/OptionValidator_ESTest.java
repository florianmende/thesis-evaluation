...
public class OptionValidator_ESTest extends OptionValidator_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      try { 
        OptionValidator.validate("]4V2]>k_4Ujuf6Q");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option ']4V2]>k_4Ujuf6Q' contains an illegal character : ']'
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test7()  throws Throwable  {
      String string0 = OptionValidator.validate("v");
  ...
  public void test9()  throws Throwable  {
      String string0 = OptionValidator.validate("WLIz");
      assertEquals("WLIz", string0);
  }
}
