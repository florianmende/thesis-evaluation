...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // java.lang.NoSuchMethodException; Unable to create an instance of: org.apache.commons.cli.Option
         //
  ...
  public void test02()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("org.apache.commons.cli.TypeHandler");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "+.g ?;f/jr}`Z$N");
      FileInputStream fileInputStream0 = TypeHandler.openFile("org.apache.commons.cli.TypeHandler");
  ...
  public void test04()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/=f}y=F1F+A");
      byte[] byteArray0 = new byte[3];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      File file0 = TypeHandler.createFile("/=f}y=F1F+A");
      assertTrue(file0.canExecute());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      File file0 = TypeHandler.createFile("^zW)F}Py>flZ/.%%\"");
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue("( PzXc3Zo{Cu>`D", (Object) "( PzXc3Zo{Cu>`D");
  ...
  public void test11()  throws Throwable  {
      try { 
        TypeHandler.createObject("R%uUp',@H(.FkC_");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: R%uUp',@H(.FkC_
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      try { 
        TypeHandler.createClass("~-;G>@./7hG:");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: ~-;G>@./7hG:
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        TypeHandler.createValue(" [ARG]", class0);
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        TypeHandler.createDate("/=f}y=F1F+A");
